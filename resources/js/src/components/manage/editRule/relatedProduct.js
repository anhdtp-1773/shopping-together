                        ...
                        ?
                            <div className="row">
                                {products.map((product, i)=>(
                                    <span className={classNames('col-sm-6 col-md-2 col-xs-6 product-wrap', {'disabled-form': idMainProduct == product.id_shopify_product ? true : false})} key={i} onClick={this.onSelectRelatedProduct.bind(this, product.id)}>
                                        <div className={classNames('thumbnail', {'disabled-form  product-step2': idMainProduct == product.id_shopify_product ? true : false})}>
