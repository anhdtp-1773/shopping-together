...
export default class NewPrice extends Component {
    ...
    render () {
        const {newPriceFontFamily, newPriceFontStyle, newPriceFontSize, newPriceFontColor, validates, newPrice} = this.props;
        const {displayFontColor} = this.state;
        return (
            <div className="full-width display-block">
                <p data-index="newPrice" className="btn btn-block" onClick={this.toggle}>{lang.sale_price}</p>
                <div className={(newPrice ? '' : 'collapse')}> 
                    <div className="full-width display-block">
