...
class CartRule extends Model
{
    ...
    public static function getCartRule($id_shop, $id_product) {
        ...
        $sql->select('cart_rule_detail.id_product', 'cart_rule_detail.is_main_product','cart_rule.name','cart_rule.code','cart_rule.status',
                    'cart_rule.reduction_percent', 'cart_rule.start_date','cart_rule.end_date');
